...
class CryptoCompare(CryptoCompareClient):
    ...
    def get_exchanges_top_symbols_by_volume(self, exchange="Binance", limit=100, **kwargs):
        data = self._get_exchanges_top_symbols_by_volume(exchange, limit, **kwargs)['Data']
    ...
    def get_latest_social_coin_stats(self, coin_id=7605, **kwargs):
        ...
        for col in ['twitter_account_creation', 'reddit_community_creation',
                    'coderepository_last_update', 'coderepository_created_at',
